...
par(mfrow = c(2, 3))
plot(density(getBeta(raw_25)),       main = "Raw 25")
plot(density(getBeta(swan_25)),      main = "SWAN 25")
plot(density(getBeta(quantile_25)),  main = "Quantile 25")
plot(density(getBeta(noob_25)),      main = "Noob 25")
plot(density(getBeta(funnorm_25)),   main = "Funnorm 25")

# Example for RGset_32
par(mfrow = c(2, 3))
plot(density(getBeta(raw_32)),       main = "Raw 32")
plot(density(getBeta(swan_32)),      main = "SWAN 32")
plot(density(getBeta(quantile_32)),  main = "Quantile 32")
plot(density(getBeta(noob_32)),      main = "Noob 32")
plot(density(getBeta(funnorm_32)),   main = "Funnorm 32")
...
# Example for RGset_25
par(mfrow = c(2, 3))
plotMDS(getM(raw_25),       main = "Raw 25")
plotMDS(getM(swan_25),      main = "SWAN 25")
plotMDS(getM(quantile_25),  main = "Quantile 25")
plotMDS(getM(noob_25),      main = "Noob 25")
plotMDS(getM(funnorm_25),   main = "Funnorm 25")

# Example for RGset_32
par(mfrow = c(2, 3))
plotMDS(getM(raw_32),       main = "Raw 32")
plotMDS(getM(swan_32),      main = "SWAN 32")
plotMDS(getM(quantile_32),  main = "Quantile 32")
plotMDS(getM(noob_32),      main = "Noob 32")
plotMDS(getM(funnorm_32),   main = "Funnorm 32")
```
...
variances_25$Dataset <- "25 Samples"
variances_32$Dataset <- "32 Samples"
...
ggplot(variances_long, aes(x = Method, y = Variance, fill = Dataset)) +
  ...
  scale_fill_manual(values = c("25 Samples" = "#66c2a5", "32 Samples" = "#fc8d62")) +
