...
```{r}
# Read the .h5ad file
sce <- readH5AD("/Users/adiallo/Desktop/Thesis/Data_Documents/All_Data/Visium_samples/Visium_Data/samples/11_C9-30_A6_1_adata.h5ad")
hires_image <- metadata(sce)$spatial$X11_C9.30_A$images$hires
